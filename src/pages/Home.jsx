...
const Home = () => {
  ...
  const products = [
    ...
    { 
      ...
      stock: 67, 
      category: "Mid-range", 
      image: "https://images.unsplash.com/photo-1600374917838-1df876d745c7" 
    },
    { 
      id: 5, 
      ...
      stock: 18, 
      category: "Premium", 
      image: "https://images.unsplash.com/photo-1657223143975-d29d7959a70f" 
    },
    { 
      id: 6, 
      ...
      stock: 15, 
      category: "Premium", 
      image: "https://images.unsplash.com/photo-1628329567705-f8f7150c3cff" 
    },
    { 
      id: 7, 
      ...
      stock: 120, 
      category: "Mid-range", 
      image: "https://i.guim.co.uk/img/media/e03285f3793514a73726cc0edcd13014a6c00fe2/62_255_5388_3232/master/5388.jpg?width=445&dpr=1&s=none&crop=none" 
    },
    { 
      id: 8, 
    ...
    { 
      ...
      stock: 55, 
      category: "Premium", 
      image: "https://cdni.dienthoaivui.com.vn/x,webp,q100/https://dashboard.dienthoaivui.com.vn/uploads/wp-content/uploads/images/tai-nghe-chup-tai-co-day-oneodio-pro-10-pbl-1.jpg" 
    },
    { 
      id: 10, 
      ...
      stock: 80, 
      category: "Mid-range", 
      image: "https://images.unsplash.com/photo-1602833703296-0b79f0b08b0e" 
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center gap-8 text-lg">
            ...
            {user && (
              <div className="flex items-center gap-4">
                ...
                <button onClick={logout} className="bg-red-500 hover:bg-red-600 text-white px-6 py-2.5 rounded-xl transition">Đăng xuất</button>
              </div>
            )}
          </div>
        </div>
      ...
      <section className="bg-gradient-to-br from-indigo-700 to-purple-700 text-white py-28 text-center">
        ...
        <button onClick={() => navigate('/products')} className="bg-white text-indigo-700 px-12 py-5 rounded-2xl text-xl font-semibold hover:bg-gray-100 transition">Mua Ngay</button>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <h3 className="text-3xl font-bold mb-8 flex items-center gap-3"> Top Sản Phẩm Xem Nhiều Nhất</h3>
        <div className="flex gap-6 overflow-x-auto pb-8 snap-x scrollbar-hide">
